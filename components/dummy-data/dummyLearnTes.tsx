...
import copypython from "@/assets/copypython.png";
import banner from "@/assets/newsImage3.png";
import banner2 from "@/assets/newsImage2.png";

const dummyLearTes = {
  "back-end-development-and-apis-certification": {
    data: [
      {
        title1: "Back End Development and",
        title2: "APIs",
        logo: (
          <svg
            aria-hidden="true"
    ...
    dataCardList: [
      {
        course: "Learn How Script Tags and Document Ready Work",
      },
      {
        course: "Learn How Script Tags and Document Ready Work",
      },
  ...
  "front-end-development-libraries-certification": {
    data: [
      {
        ...
        desc1:
          "Now that you're familiar with HTML, CSS, and JavaScript, level up yourskills by learning some of the most popular front end libraries in theindustry.",
        desc2:
    ...
    dataCardList: [
      {
        course: "Use Responsive Design with Bootstrap Fluid Containers",
      },
      {
        course: "Make Images Mobile Responsive",
      },
      {
        course: "Center Text with Bootstrap",
      },
      {
        course: "Create a Bootstrap Button",
      },
      {
        course: "Create a Block Element Bootstrap Button",
      },
      {
        course: "Taste the Bootstrap Button Color Rainbow",
      },
      {
        course: "Use Responsive Design with Bootstrap Fluid Containers",
      },
  ...
  "data-analysis-with-python-certification": {
    data: [
      {
        title1: "Data Analysis with Python",
        title2: "",
        logo: (
          <svg
            aria-hidden="true"
  ...
  "legacy-responsive-web-design-challenges": {
    data: [
      {
        title1: "Legacy Responsive Web",
        title2: "Design Challenges",
        logo: (
          <svg
            aria-hidden="true"
            viewBox="0 0 640 512"
    ...
    data: [
      {
        ...
        desc3:
          "Note: Some browser extensions, such as ad-blockers and dark modeextensions can interfere with the tests. If you face issues, werecommend disabling extensions that modify the content or layout ofpages, while taking the course.",
        desc4: "",
      },
    ],
    dataCard: [
      ...
      },
      {
        ...
        desc1:
          "Your journey begins here as you learn how to set up a Colab Notebook that can run Python code. Then, use the notebook to follow along with the videos to learn ratios and proportions using Python.",
        desc2: "coding prep lesson 2",
        desc3: "coding prep lesson3",
        desc4: "",
      },
    ],
    dataCardList: [
  ...
  "college-algebra-with-python-certification": {
    data: [
      {
        title1: "College Algebra with Python",
        title2: "",
        logo: (
          <svg
            aria-hidden="true"
    ...
    dataCard: [
      {
        ...
        desc1:
          "Your journey begins here as you learn how to set up a Colab Notebook that can run Python code. Then, use the notebook to follow along with the videos to learn ratios and proportions using Python.",
        desc2: "coding algbrea prep",
        desc3: "coding algebra prep2",
        desc4: "",
      },
      {
        title: "Learn HTML by Building a Cat Photo App",
        desc1:
          "Your journey begins here as you learn how to set up a Colab Notebook that can run Python code. Then, use the notebook to follow along with the videos to learn ratios and proportions using Python.",
        desc2: "coding algebra prep lesson 2",
        desc3: "coding algebra prep lesson3",
        desc4: "",
      },
    ],
    dataCardList: [
