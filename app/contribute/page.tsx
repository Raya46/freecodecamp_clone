  ...
  return (
    <div className="bg-white w-full h-full">
      <div className="container mx-auto ">
        <div className="flex flex-col justify-center text-[#34495E]">
          <div className="flex justify-center text-3xl mt-20">
            Contribute to freeCodeCamp.org
          </div>
          <div className="flex justify-center text-xl mt-16">
            This community is possible thanks to thousands of kind volunteers
            like you.
          </div>
          ...
          <div className="flex justify-center mt-10">
            <button className="py-6 px-16 bg-[#0A0A23] rounded-full text-xl text-white">
